...
def disconnectWithClient(message, client, client_name):
   ...
   if(entered_client_name in clients):
       ...
       greet_message =f"hello {entered_client_name}. You are succsesfully disconnected with {client_name}."
       other_client_socket.send(greet_message.encode())
       msg= f"you are succsesfully disconnected with {entered_client_name}"
